...
{{--        </tr>        --}}
        ...
        <tr class="text-c">
            <th width="25"><input type="checkbox" value="{{ $value->id }}" name=""></th>
            <th width="40">{{ $value->id }}</th>
            <th width="200">{{ $value->role_name }}</th>
            <th>{{ $value->auth_ids ? $value->auth_ids: '暂无'}}</th>
            <th width="300">{{ $value->auth_ac ? $value->auth_ac: '暂无'}}</th>
            <td class="f-14">
                <a title="分配" href="javascript:;" onclick="admin_role_assign('分配权限','admin-role-assign.html','1')" style="text-decoration:none"><i class="Hui-iconfont">&#xe60c;</i></a>
